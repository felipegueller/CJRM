...
const showRegexResult = (regex, value) => {
...
const handleSubmit = event => {
    ...
    const { input } = form
    const containsAtLeast7Characters = /.{7,}/
    showRegexResult(containsAtLeast7Characters, input.value);
    clearInput()
}
...
*/
console.log(/documentation/.test(paragraph.textContent))
...
*/
const containsBetween7and11Characters = /[a-zA-Z1-9]{7,11}/
showRegexResult(containsBetween7and11Characters, '0xY79aYx54e')
showRegexResult(containsBetween7and11Characters, 'eich_1961')
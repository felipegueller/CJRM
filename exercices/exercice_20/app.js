...
const counterDisplay = document.querySelector('h1.counter-container')
...
const incrementCounter = (log) => {
  const incrementedCounter = Number(counterDisplay.textContent) + 1;
  counterDisplay.textContent = incrementedCounter
}
...
btnInitCounter.addEventListener('click', initCounter)
btnStopCounter.addEventListener('click', stopCounter)
